      ...
      <main className="flex-1 pt-[80px] md:pt-[116px] flex items-center justify-center px-4 py-12 md:py-20">
        <div className="w-full max-w-[420px]">
          ...
          <div className="mt-8 md:mt-10 p-4 bg-[#faf9f7] border border-black/5">
            <p className="text-[9px] tracking-[0.15em] uppercase text-[#c9a96e] font-medium mb-2">Sample Login</p>
            <p className="text-[10px] text-black/60 leading-relaxed">
              Use any email and password to sign in. This is a demo account for testing purposes.
            </p>
          </div>
        </div>
      </main>
