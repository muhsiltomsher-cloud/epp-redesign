      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 md:px-6 py-12 md:py-24">
          ...
          <div className="mb-8 md:mb-16">
            <Link href="/collection" className="inline-flex items-center gap-2 text-sm uppercase tracking-widest text-foreground/60 hover:text-foreground transition-colors luxury-underline pb-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24">
            ...
            <div className="flex flex-col gap-4 animate-in fade-in slide-in-from-left-8 duration-700">
              <div className="aspect-[4/5] bg-white relative overflow-hidden flex items-center justify-center p-12">
                <img 
                  src={product.image} 
                  alt={product.name} 
            ...
            <div className="flex flex-col justify-center animate-in fade-in slide-in-from-right-8 duration-700 delay-150">
              <span className="text-accent tracking-[0.2em] text-sm uppercase mb-4 font-medium block">{product.collection}</span>
