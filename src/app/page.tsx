  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1">
        ...
        {/* New Arrivals */}
        <section className="py-16 md:py-20 bg-[#fafafa] px-4 md:px-8 lg:px-16 xl:px-24">
        ...
        {/* Banner */}
        <section className="py-20 md:py-28 bg-[#1a1308] text-white text-center px-4 md:px-8 lg:px-16 xl:px-24">
