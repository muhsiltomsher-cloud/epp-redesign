    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 pt-[88px] md:pt-[106px] pb-24 md:pb-0">
        <section className="epp-container py-12 md:py-16 text-center space-y-4 fade-in-up">
          <p className="text-[10px] uppercase tracking-[0.35em] text-gray-400">Boutiques</p>
          <h1 className="text-2xl md:text-3xl font-serif">Find a Store</h1>
          <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto">
            Visit our boutiques to experience Emirates Pride in person, discover limited releases, and enjoy private consultations.
          </p>
          <a
